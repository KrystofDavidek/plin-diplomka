...
Jelikož jsme jsme vyvíjeli webovou aplikaci, museli jsme tak brát ohled na zásady responzivního designu. Jedná se o~způsob stylování HTML (primárně pomoci CSS, ale i~JavaScriptu) pomocí různých flexibilních struktur (např. \emph{grid}), jehož výsledkem má být optimální zobrazení na všech možných obrazovkách.
