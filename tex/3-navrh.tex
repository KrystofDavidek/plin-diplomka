...
\hypertarget{technologie-spojenuxe9-s-mapovou-aplikacuxed}{%
\subsection{Technologie spojené s~mapovou aplikací}\label{technologie-spojenuxe9-s-mapovou-aplikacuxed}}
...
\item
  \textbf{Cloud Firestore} -- databázové řešení, v~němž ukládáme všechna data textové povahy. Jedná se flexibilní a~škálovatelnou NoSQL databázi, která ukládá data ve formě JSON dokumentů
\end{itemize}
