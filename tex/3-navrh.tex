...
Administraci lze otevřít až po úspěšném přihlášení, to zle provést na stránce \emph{Přihlášení} (viz obrázek \ref{ostatni}) prostřednictvím přiřazeného e-mailu a~hesla. Uživatel v~tuto chvíli nemá možnost účet založit, pro editory krajanských komunit budou v~této fázi údaje zpřístupněny po vzájemné dohodě.
...
Po přihlášení se s~v~navigačním menu objeví nová položka \emph{Editor}, v~níž probíhají všechny úkony spojené s~editace jednotlivých lokalit.
