...
Pro zobrazení výčtu dostupných lokalit slouží tlačítko menu na levé části navigačního panelu. Tímto způsobem se zobrazí postranní sekce s abecedně seřazenými lokalitami na základě aplikovaných filtrů (ve výchozím stavu bez omezení) (viz obrázek \ref{mapa-2}).
...
Pro přiblížení na konkrétní krajanskou komunitu na mapě lze využít buď tlačítko *zobrazit na mapě* u vybrané lokality, případně kliknout na modrou značku, která je zobrazená na mapě. Po jednoduché animaci je pohled mapy zacílen na danou mapovou vrstvu (viz obrázek \ref{cil-mapa}). Pokud by vedle sebe větší množství lokalit, lze je od sebe na mapě rozlišit najetím myši na mapovou vrstvu – vypíše se tak hlavní název komunity.
