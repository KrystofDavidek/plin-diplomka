...
Vlivem chorvatštiny také docházelo k četným lexikálním přejímkám – primárně se týkalo o lexikum vztahující se k státní správě, školství a zdravotnictví (*předsedník* nebo *župa*). Vznikaly také nové výrazy prostřednictvím chorvatských kalků (*Sehráli hru z minuloroční přehlidky*) anebo využívání homonym, které stejně znějí, ale mají odlišnou sémantiku (*Dnes mam vysoky paty*) \parencite{Kokaisl2012}. 